...
#' GPTCelltype_mapping: Reference Mapping of GPT-4 Annotations to Cell Ontology
#'
...
#' @usage data(GPTCelltype_mapping)
#' @examples
#' data(GPTCelltype_mapping)
#' head(GPTCelltype_mapping)
NULL
